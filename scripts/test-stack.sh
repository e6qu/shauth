...
curl --fail --silent --show-error \
  ...
  --data '{"client_id":"shauth-integration-client","client_secret":"shauth-integration-secret","grant_types":["authorization_code","refresh_token"],"response_types":["code"],"scope":"openid offline_access","redirect_uris":["http://localhost:5555/callback"],"token_endpoint_auth_method":"client_secret_post","skip_consent":false}' \
...
token_response=$(curl --fail --silent --show-error \
  ...
  --data-urlencode 'client_secret=shauth-integration-secret' \
