locals {
  ...
  shauth_environment = concat([
    ...
    { name = "HYDRA_ADMIN_URL", value = "http://127.0.0.1:4445" },
    { name = "HYDRA_PUBLIC_INTERNAL_URL", value = "http://127.0.0.1:4444" },
    { name = "GITHUB_CLIENT_ID", value = var.github_client_id },
    { name = "GITHUB_DEVELOPER_TEAM", value = var.github_developer_team },
    { name = "GITHUB_ADMIN_TEAM", value = var.github_admin_team },
    { name = "SHAUTH_BOOTSTRAP_ADMIN_EMAIL", value = var.bootstrap_admin_email },
